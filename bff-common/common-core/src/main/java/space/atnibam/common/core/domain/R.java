...
public class R<T> implements Serializable {
    ...
    public static <T> R<T> ok() {
        return restResult(null, SUCCESS, CommonConstants.SUCCESS_OPERA);
    }
    ...
    public static <T> R<T> ok(T data) {
        return restResult(data, SUCCESS, CommonConstants.SUCCESS_OPERA);
    }
    ...
    public static <T> R<T> fail() {
        return restResult(null, FAIL, CommonConstants.FAIL_OPERA);
    }
    ...
    public static <T> R<T> fail(T data) {
        return restResult(data, FAIL, CommonConstants.FAIL_OPERA);
    }
